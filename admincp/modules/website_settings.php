...
if(isset($_POST['settings_submit'])) {
	try {
		...
		if(!array_key_exists($_POST['server_files'], $cabalengine['file_compatibility'])) throw new Exception('Invalid Server Files setting.');
		...
		echo '<table class="table table-striped table-bordered table-hover" style="table-layout: fixed;">';
			...
			echo '<tr>';
				echo '<td>';
					...
					echo '<p class="setting-description">Your Cabal Online server name.</p>';
				echo '</td>';
				echo '<td>';
			...
			echo '<tr>';
				echo '<td>';
					...
					echo '<p class="setting-description">Define your server files for maximum CabalEngine compatibility.</p>';
				echo '</td>';
				echo '<td>';

					echo '<select class="form-control" name="server_files">';
						$fileCompatibilityList = $cabalengine['file_compatibility'];
			...
			echo '<tr>';
				echo '<td>';
					...
					echo '<p class="setting-description">Default language that CabalEngine will use.</p>';
				echo '</td>';
				echo '<td>';
