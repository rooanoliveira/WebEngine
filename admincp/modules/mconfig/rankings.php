...
<form action="" method="post">
	<table class="table table-striped table-bordered table-hover module_config_tables">
		...
		<tr>
			<th>Rankings Results<br /><span>Amount of ranking results CabalEngine should cache.</span></th>
			<td>
		...
		<tr>
			<th>Default Rankings<br /><span>Which rankings will be shown by default when accessing to the rankings page.<br /><br />Options:<ul>
						<li>level</li>
						<!-- <li>resets</li>
						<li>killers</li>
						<li>grandresets</li> -->
		...
		<tr>
			...
			<td>
				<select class="form-control" name="setting_21">
					...
					<option value="2" <?php if ($moduleConfig->guild_score_formula == 2) echo 'selected'; ?>>CabalEngine CMS Custom 1: (STR+AGI+VIT+ENE+CMD) * MULTIPLIER</option>
					<option value="3" <?php if ($moduleConfig->guild_score_formula == 3) echo 'selected'; ?>>CabalEngine CMS Custom 2: (STR+AGI+VIT+ENE) * MULTIPLIER</option>
				</select>
			</td>
		</tr>
		<tr>
			<th>Multiplier<br /><span>If the score setting is set to one of CabalEngine's custom score formulas, use the multiplier to customize how big or small you want the scores to be.</span></th>
			<td>
